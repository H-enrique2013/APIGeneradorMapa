    ...
    def ProcesarModel(dep,prov,distr,sec_est,n_aleatorio,campo_sector,tip_archivo):
        try:
            ...
            try:
                ...
                print("Error en CalculoLongProyecciones:", e)
                print(f"btuni: {btuni}")
                print(f"line_bastones: {line_bastones}")
                raise
            ...
            import traceback
            print("Ocurrió un error en ProcesarModel:")
            print(f"Tipo de error: {type(e).__name__}")
            print(f"Mensaje de error: {e}")
            print("Rastreo completo:")
            traceback.print_exc()
            # Puedes registrar el error en un archivo de logs o tomar acciones adicionales
            return None
